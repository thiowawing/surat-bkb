    ...
    <div class="modal-content">
        ...
        <form id="formBKB" onsubmit="simpanBKB(event)">
            ...
            <div class="form-row">
                ...
                <!-- KOLOM MANAGER DIBUAT OTOMATIS "Fariz Asad" & PERMANEN -->
                <div class="form-group">
                    <label>Nama Manager Logistik</label>
                    <input type="text" id="nama_manager" value="Fariz Asad" readonly required>
                </div>
                <div class="form-group">
...
<div id="printableArea">
    ...
    <table style="width: 100%; font-size: 13px; margin-bottom: 15px;">
        ...
        <tr>
            ...
            <td style="border: none;">:</td>
            <td style="border: none;" id="printManager">Fariz Asad</td>
        </tr>
        <tr>
    ...
    <div class="print-footer" style="display: flex; justify-content: space-between;">
        ...
        <div>
            ...
            <div class="signature-box"></div>
            <p>( <span id="printSignManager">Fariz Asad</span> )</p>
        </div>
    </div>
</div>
